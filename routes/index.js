...
/**
 * data входные данные которые могли бы получаться гдето с БД, но пока такой кривой и хадкорынй вариант,
 * Для Вью опять таки хардкорно выдаю при Рендеринге страницы, (лучше для сео, в остальном выглядит ужасно)
 */
...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Test app for GNS' , data: data});
});
