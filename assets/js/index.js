...
new Vue({
    ...
    methods: {
        ...
        sortList(param, reverse) {
            this.$nextTick(() => {
                this.sortedParams.isSorted = true;
                this.sortedParams.name = param;
                this.sortedParams.reverse = reverse;
            });
        }
    }
});