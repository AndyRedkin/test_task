...
new _vue2.default({
    ...
    methods: {
        ...
        editItemConfirm: function editItemConfirm(name) {
            if (this.modals.edit.name === 'currency') {
                this.list[this.modals.edit.index][name] = parseInt(this.modals.edit.value ? this.modals.edit.value : 0);
            } else {
                this.list[this.modals.edit.index][name] = this.modals.edit.value;
            }
        ...
        sortList: function sortList(param, reverse) {
            ...
            this.$nextTick(function () {
                _this2.sortedParams.isSorted = true;
                _this2.sortedParams.name = param;
                _this2.sortedParams.reverse = reverse;
            });
        }
    }
});
